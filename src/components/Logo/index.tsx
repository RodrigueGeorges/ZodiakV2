...
const Logo = memo(function Logo({ size = 'md', className = '' }: LogoProps) {
  ...
  return (
    <div className={`relative flex items-center justify-center ${sizeMap[size]} group ${className}`}>
      {/* Outer cosmic ring */}
      ...
      <div className="relative transform group-hover:scale-110 transition-transform duration-500">
        <div className="absolute inset-0 bg-[#D8CAB8] rounded-full blur-xl opacity-20 animate-glow group-hover:opacity-30 transition-opacity duration-500" />
